...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='p2c_code_test' \
    trainer.experiment_name='qwen2.5-vl-3b_p2c' \
    trainer.n_gpus_per_node=1 \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=20 \
    data.train_files=$PROJECT_DIR/data/plot2code_multiturn_w_tool/test.parquet \
    data.val_files=$PROJECT_DIR/data/plot2code_multiturn_w_tool/test_1.parquet \
